export default [
  {
    ...
    paragraphs: [
      "If you love the world of She Socials, we would absolutely love to hear from you! Please reach out via our contact form and we will book you in for your initial consultation.",
  ...
  },
  {
    ...
    paragraphs: [
      "Now that you know that we’re the perfect fit. It’s time to make the investment.",
  ...
  {
    title: "Step 3",
    subTitle: "Your Vision Consultation",
    paragraphs: [
  ...
  {
    title: "Step 4",
    subTitle: "Time to Tie the Knot",
    paragraphs: [
      "The day has finally come and you’re about to be the latest newlyweds.",
  ...
  {
    title: "Step 5",
    subTitle: "No Post Wedding Blues",
    paragraphs: [
      "Every newlywed will agree that the post-wedding blues are definitely real.",
